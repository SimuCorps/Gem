...
run_category() {
    ...
    case "$category" in
        ...
        "mutability")
            ...
            ;;
        "advanced")
            tests=("test_memory_safety.gem" "test_type_safety.gem" "test_jit_compilation.gem" "test_hashes.gem" "test_type_coercion.gem" "test_http.gem" "test_borrow_checking.gem")
            ;;
        *)
