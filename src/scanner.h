...
typedef enum {
  ...
  // Keywords.
  TOKEN_AND, TOKEN_AS, TOKEN_BEGIN, TOKEN_CLASS, TOKEN_DEF, TOKEN_ELSE, TOKEN_ELSIF,
  TOKEN_END, TOKEN_FALSE, TOKEN_FOR, TOKEN_FUN, TOKEN_IF, TOKEN_MODULE, TOKEN_MUT, TOKEN_NIL, TOKEN_OR,
